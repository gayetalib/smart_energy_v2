			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="assets\images\logo_smart.jpg" class="brand_logo" alt="Logo">
					</div>
				</div><br>
					...
					<form>
						...
						<!-- <div class="form-group">
							...
							<div class="d-flex justify-content-center mt-3 login_container">
				             	<button type="button" name="button" class="btn login_tn" style="background-color: #282c34;color:wheat;font-size:18px;" >Se connecter</button>
				            </div>
					</form>
				</div>
